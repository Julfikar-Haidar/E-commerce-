...
if($_SERVER['REQUEST_METHOD']=='POST' && isset($_POST['submit'])){
    ...
    $productUpdate=$product->productUpdated($_POST,$_FILES,$id);  
}
...
<div class="grid_10">
    <div class="box round first grid">
        ...
        <div class="block"> 
            ...
            <?php   
            $getProductdata=$product->getproducById($id);
            if($getProductdata){
                while ($value=$getProductdata->fetch_assoc()){
         ...
         <form action="" method="post" enctype="multipart/form-data">
	        ...
	        <tr>
                ...
                <tr>
                    ...
                    <td>
                    <img src="<?php echo $value['image'];?> " width="80px" height="80px" /><br>
